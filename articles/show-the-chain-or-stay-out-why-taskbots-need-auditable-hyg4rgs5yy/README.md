# aetna-research-lab
Reference implementation for Show the Chain or Stay Out: Why Taskbots Need Auditable Evidence in Product Workflows
## Article
Show the Chain or Stay Out: Why Taskbots Need Auditable Evidence in Product Workflows
The real bottleneck for trustworthy multimodal agents is auditable evidence chains, screen, intent, action, and outcome, or they don’t belong in product workflows.
## Purpose
