# aetna-research-lab
Reference implementation for Why Multimodal Agents Need Evidence Chains, Not Just Actions
## Article
Why Multimodal Agents Need Evidence Chains, Not Just Actions
For multimodal agents in production workflows, evidence chains, not just action generation, are the bottleneck for trust.
## Purpose
